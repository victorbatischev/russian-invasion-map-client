...
import './header.scss'
import {currentDate, mapCenterDonbass, mapCenterUkraine, menuHeaderList} from "../../Constants";
        ...
        <div className="header__container">
           <nav className="header__menu menu">
              <ul className={'menu__top'}>
                 {menuHeaderList.map((item, index) => (
                   <li
                     key={item.id}
                     data-index={index}
                     className={index === active ?  "menu__item-top menu__item-top_active" : "menu__item-top"}
              ...
              <ul className="menu__date-list">
                 ...
                 <li className="menu__item-date">Выбранная дата:
                    <Calendar
                 ...
                 <li className="menu__item-date"> Период:
                    <Calendar
                      startDate={startDate}
                      endDate={endDate}
